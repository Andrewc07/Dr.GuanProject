...
//Name: Planars.ma
//Last modified: Fri, Jul 04, 2014 02:06:00 AM
//Codeset: UTF-8
requires maya "2013";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -17.679417790643122 5.9770048731165542 11.42424615362355 ;
	setAttr ".r" -type "double3" -12.938352729348521 -58.999999999978648 -1.5438444439360109e-15 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 18.894252436313696;
...
createNode mesh -n "screen_bottom01Shape" -p "screen_bottom01";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.23681855201721191 0.67984202645959391 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
...
createNode polyPlanarProj -n "polyPlanarProj9";
	...
	setAttr ".ro" -type "double3" 9.1394503304761002e-15 45.89258864145436 -89.999999999999986 ;
...
connectAttr "screen_top01Shape.iog" ":initialShadingGroup.dsm" -na;
connectAttr "screen_bottom01Shape.iog" ":initialShadingGroup.dsm" -na;
