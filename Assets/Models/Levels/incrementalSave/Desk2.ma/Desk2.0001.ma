...
//Name: Desk2.ma
//Last modified: Fri, Jul 04, 2014 02:28:24 PM
//Codeset: UTF-8
requires maya "2013";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -10.3454629330699 0.87026843348539629 0.40289060391820986 ;
	setAttr ".r" -type "double3" -16.199999999999044 -99.999999999993577 0 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 9.9675551353744414;
...
select -ne :defaultHardwareRenderGlobals;
	...
	setAttr -k on ".gh";
	setAttr -cb on ".sd";
connectAttr "polyMergeVert1.out" "desk_segment01Shape.i";
