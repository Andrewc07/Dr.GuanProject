...
//Name: Desk2.ma
//Last modified: Fri, Jul 04, 2014 02:52:24 PM
//Codeset: UTF-8
requires maya "2013";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -1.2735956674703393 -0.0021068783979945049 -6.2686733144621529 ;
	setAttr ".r" -type "double3" -1.7999999999996845 -161.19999999997182 0 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 7.6771429456779989;
...
createNode mesh -n "desk_segment01Shape" -p "desk_segment01";
	...
	setAttr -s 6 ".pt";
	setAttr ".pt[2]" -type "float3" 2.3283064e-10 0 0 ;
	setAttr ".pt[18]" -type "float3" 7.4505806e-09 -1.4901161e-08 0 ;
	setAttr ".pt[29]" -type "float3" 2.3283064e-10 0 0 ;
	setAttr ".pt[52]" -type "float3" 2.3283064e-10 0 0 ;
	setAttr ".pt[70]" -type "float3" 2.3283064e-10 0 0 ;
	setAttr ".pt[82]" -type "float3" 2.3283064e-10 0 0 ;
	setAttr ".dr" 1;
...
createNode polyExtrudeFace -n "polyExtrudeFace2";
	setAttr ".ics" -type "componentList" 2 "f[21:22]" "f[68:69]";
	setAttr ".ix" -type "matrix" 4.4408965273504233 0 0 0 0 4.4408965273504233 0 0 0 0 4.4408965273504233 0
		 0 0 0 1;
	setAttr ".ws" yes;
	setAttr ".pvt" -type "float3" 1.1366576 0.10786284 0 ;
	setAttr ".rs" 440932678;
	setAttr ".c[0]"  0 1 1;
	setAttr ".cbn" -type "double3" 1.0701064276899475 0.10786283817315503 -2.0247564585233184 ;
	setAttr ".cbx" -type "double3" 1.2032087221926777 0.10786283817315503 2.0247564585233184 ;
select -ne :time1;
	setAttr -av -k on ".cch";
	setAttr -cb on ".ihi";
	setAttr -k on ".nds";
...
select -ne :ikSystem;
	setAttr -s 4 ".sol";
connectAttr "polyExtrudeFace2.out" "desk_segment01Shape.i";
...
connectAttr "desk_segment01Shape.wm" "polyMirror1.mp";
