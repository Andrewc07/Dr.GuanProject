...
//Name: Desk.ma
//Last modified: Fri, Jul 04, 2014 03:26:17 PM
//Codeset: UTF-8
requires maya "2013";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -5.1223536084899726 2.8659847111368175 4.7288250012106356 ;
	setAttr ".r" -type "double3" -24.000000000061103 -55.999999999992404 359.99999999999613 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 7.6924598334226717;
...
createNode polyExtrudeFace -n "polyExtrudeFace2";
	...
	setAttr ".lt" -type "double3" 0 6.6613385447976574e-17 0.30000001788139452 ;
	setAttr ".c[0]"  0 1 1;
	setAttr ".cbn" -type "double3" 1.0701063871383667 0.10786283761262894 -2.0247564315795894 ;
...
createNode deleteComponent -n "deleteComponent4";
	setAttr ".dc" -type "componentList" 9 "f[0:13]" "f[35:40]" "f[45]" "f[48:54]" "f[61:62]" "f[71:73]" "f[80:102]" "f[150:152]" "f[157:158]";
select -ne :time1;
	setAttr -av -k on ".cch";
	setAttr -cb on ".ihi";
	setAttr -k on ".nds";
